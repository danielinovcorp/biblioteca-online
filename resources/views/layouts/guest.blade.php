		...
		<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
			<div class="flex h-16 items-center justify-between">
				<div class="flex items-center">
					<div class="shrink-0">
						<a href="{{ route('home') }}">
							<img class="size-8" src="{{ asset('logo.svg') }}" alt="Biblioteca" />
						</a>
					</div>
					...
					<div class="block">
						<div class="ml-10 flex items-baseline space-x-4">
							...
							@auth
							<x-nav-link href="{{ url('/dashboard') }}" :active="request()->is('dashboard')">Dashboard</x-nav-link>
							@endauth
						</div>
					</div>
				</div>
				...
				<div class="block">
					<div class="ml-4 flex items-center md:ml-6">
						...
						@else
						<!-- Botões de login e registo (para visitantes) -->
